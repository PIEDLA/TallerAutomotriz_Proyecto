...
namespace asp_servicios.Controllers
{
    ...
    public class Reserva_ServicioController : ControllerBase
    {
        private IReserva_ServicioAplicacion? iAplicacion = null;
        private TokenAplicacion? iAplicacionToken = null;

        public Reserva_ServicioController(IReserva_ServicioAplicacion? iAplicacion, TokenAplicacion iAplicacionToken)
        {
        ...
        public string PorReserva()
        {
            ...
            try
            {
                ...
                var entidad = JsonConversor.ConvertirAObjeto<Reserva_Servicio>(
